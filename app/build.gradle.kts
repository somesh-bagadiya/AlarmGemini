...
android {
    namespace = "com.example.alarmgemini"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.alarmgemini"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
        ...
        // Expose Gemini API key from a local gradle property (defined in local.properties or gradle.properties)
